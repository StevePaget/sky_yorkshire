# Yorkshire Sky Colours @sky-yorkshire
...
6. Using the Red, Green, Blue values, [send these over](https://www.w3schools.com/python/module_requests.asp) to the amazing color-naming API at [https://github.com/meodai/color-names](https://github.com/meodai/color-names) , and get the response. [Read the name from the JSON it sends back.](https://developer.rhino3d.com/guides/rhinopython/python-xml-json/)
